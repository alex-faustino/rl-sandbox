...
class MyAcrobot(core.Env):
    ...
    **REFERENCE:**
    ...
    #ACTION_M = 1.0
    #AVAIL_TORQUE = [-ACTION_M, 0., ACTION_M]
    ...
    def step(self, a):
        ...
        #reward = -1. if not terminaprint(asd, state)l else 0.
        #if ns[0]>(np.pi/2-self.reward_delta) and ns[0]<(np.pi/2+self.reward_delta) and ns[1]>-self.reward_delta and ns[1]<self.reward_delta:
        #if ns[0]>(np.pi-self.reward_delta) and ns[0]<(-np.pi+self.reward_delta) and ns[1]>-self.reward_delta and ns[1]<self.reward_delta:
        #    reward = 1.0
        #else:
        #    reward = 0.0
