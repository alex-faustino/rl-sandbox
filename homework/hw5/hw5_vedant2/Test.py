...
Q2, rewards2 = DA.Reinforce(env,initial_epsilon = 1, final_epsilon = 0.01,total_episodes = 1000, 
              annealing_period = None,max_steps = 25,lr_rate = 0.99, gamma = 1, 
              batch_size = 10,decay_rate = None, Imp_samp = False , Causility = True , Base_shift = False)
V2 = np.amax(Q2, axis=1)
V2 = V2.reshape(5,5)
pi2 = np.argmax(Q2, axis=1)
pi2 = pi2.reshape(5,5)
...
Q2, rewards2 = DA.Reinforce(env,initial_epsilon = 1, final_epsilon = 0.01,total_episodes = 1000, 
              annealing_period = None,max_steps = 25,lr_rate = 0.99, gamma = 1, 
              batch_size = 10,decay_rate = None, Imp_samp = True , Causility = False , Base_shift = False)
V2 = np.amax(Q2, axis=1)
V2 = V2.reshape(5,5)
pi2 = np.argmax(Q2, axis=1)
pi2 = pi2.reshape(5,5)
