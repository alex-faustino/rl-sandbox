...
class PolicyGradient():
    ...
    def __init__(self,state_dim,action_dim,Lr):
        ...
        #self.bias = tf.reduce_sum(self.responsible_outs*self.reward_holder)
...
with tf.Session() as sess:
    ...
    if easy:
        ...
        file_name = 'hw5_bias_PGgridWorldmlp_easyon'
    else:
        # File Name for saving the Results to file
        file_name = 'hw5_bias_PGgridWorldmlp_easyoff'
    ...
    for epoch in range(MAX_EPISODE):
        ...
        for ep_length in range(LEN_EPISODE):
            ...
            ep_history.append((np.reshape(s,(state_dim,)),action,r-bias,np.reshape(s1,(state_dim,))))
            s = s1
            running_r += r
