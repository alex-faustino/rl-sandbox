...
# -*- coding: utf-8 -*-
"""
Created on Thu Oct 25 00:19:08 2018
...
class Model(nn.Module):
    def __init__(self, num_inputs, num_outputs):
        ...
        self.p_fc3 = nn.Linear(h_size_1, h_size_2)
        self.p_fc4 = nn.Linear(h_size_1, h_size_2)
        
        self.v_fc1 = nn.Linear(num_inputs, h_size_1)
        self.v_fc2 = nn.Linear(h_size_1, h_size_2)
        self.v_fc3 = nn.Linear(h_size_1, h_size_2)
        self.v_fc4 = nn.Linear(h_size_1, h_size_2)
