...
class AcrobotEnv(core.Env):
    ...
    Moment = 10 #: Moment exerted on first joint
    ...
    def reset(self):
        self.state = self.np_random.uniform(low=-0.1, high=0.1, size=(4,1))
        self.reward = 0
        return self._get_ob()
    ...
    def step(self, a):
        ...
        return self._get_ob(), self.reward

    def _get_ob(self):
        s = self.state
        a = np.array([s[0], s[1], s[2], s[3]])
        a = np.reshape(a, (4,1))
        return a
