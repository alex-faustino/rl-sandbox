...
class Policy():
    ...
    def __init__(self, env):
        ...
        #self.policy = np.array([[0.7, 0.3],[0.7, 0.3], [0.7, 0.3], [0.7, 0.3], [0.7, 0.3]])
        #self.policy = np.array([[0.8, 0.2],[0.8, 0.2], [0.8, 0.2], [0.8, 0.2]])
...
class run_REPS(object):    
    def REPS(self, env, R, policy, features, x0, epsilon, info_loss=1,
        ...
        for i in range(n_policy_updates):
            ...
            J[i] = expected_return(env, R, policy, 100, 100)
