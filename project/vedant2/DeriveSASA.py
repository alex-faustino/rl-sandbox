...
PanelR1_connection.set_pos(Body_connectionR,0*Body_frame.x+0*Body_frame.y+0*Body_frame.z)# Body_frame or PanelR1_frame?
PanelR1_connection.set_vel(PanelR1_frame,0*Body_frame.x+0*Body_frame.y+0*Body_frame.z)
PanelR1_connection.v2pt_theory(Body_connectionR,Body_frame,PanelR1_frame)
'''
