...
while (True):
    ...
    sim.data.ctrl[3] = 0 #math.cos(t / 10.) * 
    sim.data.ctrl[4] = 0
    sim.data.ctrl[5] = 0
    
    sim.data.ctrl[6] =  math.cos(t *2*np.pi* Fx+phaseXL) * 1000*i*gainX#math.cos(t / 10.) * 
    sim.data.ctrl[7] =  math.cos(t *2*np.pi* Fy+phaseYL) * 1000*i*gainY
    sim.data.ctrl[8] =  math.cos(t *2*np.pi* Fz+phaseYL) * 1000*i*gainZ
    
    sim.data.ctrl[9] =  math.cos(t *2*np.pi* Fx+phaseXR) * 1000*i*gainX#math.cos(t / 10.) * 
    sim.data.ctrl[10] = math.cos(t *2*np.pi* Fy+phaseYR) * 1000*i*gainY
    sim.data.ctrl[11] = math.cos(t *2*np.pi* Fz+phaseZR) * 1000*i*gainZ
